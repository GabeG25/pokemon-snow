...
#define B_CRIT_MULTIPLIER           GEN_5 // Snow: 2x crit damage (pre-Gen 6 rule per v17 locked mechanic)
...
#define B_PROTEAN_LIBERO            GEN_8 // Snow: Protean activates every move (pre-Gen 9). Affects Sceptile on F21/F30/F35.
