...
#define P_SUMMARY_SCREEN_RENAME          FALSE  // Snow: rename moved to party-menu NICKNAME action; restore vanilla Cancel prompt on Summary's info page.
...
#define P_SUMMARY_SCREEN_MOVE_RELEARNER  FALSE  // Snow: disabled. Players should go to a real MOVE RELEARNER NPC rather than relearning for free on the summary screen.
