...
#define P_GEN_6_POKEMON                  FALSE // Generation 6 Pokémon (XY, ORAS) — Snow uses no Gen 6 base species
#define P_GEN_7_POKEMON                  FALSE // Generation 7 Pokémon (SM, USUM, LGPE) — Snow uses no Gen 7 base species
#define P_GEN_8_POKEMON                  FALSE // Generation 8 Pokémon (SwSh, BDSP, LA) — Snow uses no Gen 8 base species
#define P_GEN_9_POKEMON                  FALSE // Generation 9 Pokémon (SV) — Snow uses no Gen 9 base species
