...
#define B_LEVEL_CAP_TYPE                LEVEL_CAP_FLAG_LIST // Snow: zone caps driven by sLevelCapFlagMap in src/caps.c (v17 §21)
#define B_LEVEL_CAP_VARIABLE            0 // event variable used to derive level cap if B_LEVEL_CAP_TYPE is set to LEVEL_CAP_VARIABLE

#define B_RARE_CANDY_CAP                TRUE  // Snow: Candy Box (Rare Candy) respects zone level caps per v17 §21
