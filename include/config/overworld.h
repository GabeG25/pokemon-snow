...
// Map pop-up config
#define OW_POPUP_GENERATION        GEN_5    // Snow: GEN_5 style full-width popup so long names like "POWDERPATH VILLAGE" fit. BW palette recolored to ice/snow tones via graphics/map_popup/bw/white.gbapal.
...
// Configuration
#define OW_POPUP_BW_COLOR          OW_POPUP_BW_COLOR_WHITE  // Snow: WHITE branch loads our ice-recolored white.gbapal; BLACK branch uses stock navy that fades into snow weather.
