...
// Boralyss Pokédex order (Pokémon Snow regional dex - 317 species)
// Enum prefix kept as HOENN_DEX_* to avoid churning the hundreds of engine
// references; semantically this enum now represents Boralyss, not Hoenn.
enum HoennDexOrder
{
    HOENN_DEX_NONE,
    // Starters
    ...
    HOENN_DEX_ABOMASNOW,
    HOENN_DEX_DELIBIRD,
    HOENN_DEX_ALOLAN_VULPIX,
    HOENN_DEX_ALOLAN_NINETALES,
    ...
    HOENN_DEX_TEDDIURSA,
    HOENN_DEX_URSARING,
    HOENN_DEX_ALOLAN_SANDSHREW,
    HOENN_DEX_ALOLAN_SANDSLASH,
    HOENN_DEX_SWINUB,
    HOENN_DEX_PILOSWINE,
    HOENN_DEX_MAMOSWINE,
    HOENN_DEX_STANTLER,
    ...
    HOENN_DEX_GALARIAN_DARUMAKA,
    HOENN_DEX_GALARIAN_DARMANITAN,
...
#define HOENN_DEX_COUNT (HOENN_DEX_KYUREM + 1)
...
// Boralyss Pokédex per-form Seen/Caught bits.
// 4 collision species (Vulpix, Ninetales, Darumaka, Darmanitan) each occupy
// two Boralyss slots: the regional variant (Alolan/Galarian) and the base form.
// These bits track each form independently so completing the dex requires
// catching both. Storage lives in gSaveBlock2Ptr->pokedex.boralyssFormSeen
// and .boralyssFormCaught.
#define BORALYSS_FORM_BIT_VULPIX_ALOLA       (1 << 0)
#define BORALYSS_FORM_BIT_VULPIX_REGULAR     (1 << 1)
#define BORALYSS_FORM_BIT_NINETALES_ALOLA    (1 << 2)
#define BORALYSS_FORM_BIT_NINETALES_REGULAR  (1 << 3)
#define BORALYSS_FORM_BIT_DARUMAKA_GALAR     (1 << 4)
#define BORALYSS_FORM_BIT_DARUMAKA_REGULAR   (1 << 5)
#define BORALYSS_FORM_BIT_DARMANITAN_GALAR   (1 << 6)
#define BORALYSS_FORM_BIT_DARMANITAN_REGULAR (1 << 7)
