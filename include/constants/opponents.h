...
// NOTE: Because each Trainer uses a flag to determine when they are defeated, there is only space for 143 additional trainers before trainer flag space overflows
