...
// NOTE: Because each Trainer uses a flag to determine when they are defeated, there is only space for 138 additional trainers before trainer flag space overflows
