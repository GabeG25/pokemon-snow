...
#if P_FAMILY_SPEAROW
// Snow custom learnset, family-shared (Spearow/Fearow identical).
#define SPEAROW_FAMILY_SNOW_LEARNSET                  \
...
#if P_ALOLAN_FORMS
// Snow custom learnset, family-shared base (16 entries identical Sandshrew-A/Sandslash-A).
// Exception: Ice Ball — Sandshrew-Alola learns at Lv 44 (delay-evolution reward),
// Sandslash-Alola learns at Lv 85.
static const struct LevelUpMove sSandshrewAlolaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(71, MOVE_HONE_CLAWS),
    LEVEL_UP_MOVE(79, MOVE_AVALANCHE),
    LEVEL_UP_MOVE(86, MOVE_ROLLOUT),
    LEVEL_UP_MOVE(93, MOVE_SWORDS_DANCE),
    LEVEL_UP_END
};
...
#if P_ALOLAN_FORMS
// Snow custom learnset, family-shared base (16 entries identical Vulpix-A/Ninetales-A).
// Exception: Hail — Vulpix-Alola learns at Lv 55 (reward for delaying evolution),
// Ninetales-Alola learns at Lv 95 (player-side cap). Weather moves are extremely
// strong in Snow (permanent weather rocks), hence the long-gated Hail timing.
...
#if P_FAMILY_GEODUDE
// Snow custom learnset, family-shared (Geodude/Graveler/Golem regular line identical).
// Alolan Electric/Rock forms below have their own learnset entries — only the
// regular line is being rebuilt here in dex order.
#define GEODUDE_FAMILY_SNOW_LEARNSET                  \
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),                   \
    LEVEL_UP_MOVE( 3, MOVE_SAND_TOMB),                \
    ...
    LEVEL_UP_MOVE(76, MOVE_STONE_EDGE),               \
    LEVEL_UP_MOVE(84, MOVE_EARTHQUAKE),               \
    LEVEL_UP_MOVE(89, MOVE_HEAD_SMASH),               \
    LEVEL_UP_END

static const struct LevelUpMove sGeodudeLevelUpLearnset[] = {
    GEODUDE_FAMILY_SNOW_LEARNSET
};
...
#if P_FAMILY_SENTRET
// Snow custom learnset, family-shared base (15 entries identical Sentret/Furret).
// Exception: Coil — Sentret learns at Lv 41 (reward for delaying evolution),
// Furret learns at Lv 95 (the player-side Snow level cap).
...
// Snow custom learnset, family-shared base (18 entries identical Teddiursa/Ursaring).
// Exception: Yawn — Teddiursa learns at Lv 66 (delay-evolution reward),
// Ursaring learns at Lv 95.
// Ursaluna / Ursaluna-Bloodmoon (Gen 8 cross-evolutions) are not in Snow's
// regional dex; their learnsets below are inherited from pokeemerald-expansion
// and are not part of this rebuild.
...
#if P_FAMILY_SWINUB
// Snow custom learnset, family-shared (Swinub/Piloswine/Mamoswine identical).
#define SWINUB_FAMILY_SNOW_LEARNSET                   \
    LEVEL_UP_MOVE( 1, MOVE_POWDER_SNOW),              \
    ...
    LEVEL_UP_MOVE(53, MOVE_BULLDOZE),                 \
    ...
    LEVEL_UP_MOVE(82, MOVE_EARTHQUAKE),               \
    LEVEL_UP_MOVE(87, MOVE_AVALANCHE),                \
    LEVEL_UP_MOVE(94, MOVE_STEALTH_ROCK),             \
    LEVEL_UP_END

static const struct LevelUpMove sSwinubLevelUpLearnset[] = {
    SWINUB_FAMILY_SNOW_LEARNSET
};
...
// Snow custom learnset (Delibird is single-stage in Boralyss dex).
static const struct LevelUpMove sDelibirdLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(83, MOVE_SHEER_COLD),
    LEVEL_UP_END
};
...
// Snow custom learnset (Stantler is single-stage in Boralyss dex).
// Wyrdeer (Gen 8 cross-evolution) below is not in Snow's regional dex; its
// learnset is inherited from pokeemerald-expansion and not part of this rebuild.
static const struct LevelUpMove sStantlerLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(86, MOVE_CALM_MIND),
    LEVEL_UP_MOVE(93, MOVE_PSYCH_UP),
    LEVEL_UP_END
};
...
#if P_FAMILY_TREECKO
// Snow custom learnset, family-shared (Treecko/Grovyle/Sceptile identical).
#define TREECKO_FAMILY_SNOW_LEARNSET                  \
    LEVEL_UP_MOVE( 1, MOVE_POUND),                    \
    LEVEL_UP_MOVE( 1, MOVE_GROWL),                    \
    LEVEL_UP_MOVE( 5, MOVE_ABSORB),                   \
    LEVEL_UP_MOVE( 8, MOVE_QUICK_ATTACK),             \
    ...
    LEVEL_UP_MOVE(39, MOVE_STUN_SPORE),               \
    LEVEL_UP_MOVE(44, MOVE_ENERGY_BALL),              \
    LEVEL_UP_MOVE(50, MOVE_GIGA_DRAIN),               \
    LEVEL_UP_MOVE(58, MOVE_X_SCISSOR),                \
    LEVEL_UP_MOVE(64, MOVE_DRAGON_PULSE),             \
    LEVEL_UP_MOVE(71, MOVE_SHED_TAIL),                \
    LEVEL_UP_MOVE(77, MOVE_SOLAR_BLADE),              \
    LEVEL_UP_MOVE(85, MOVE_LEAF_STORM),               \
    LEVEL_UP_MOVE(90, MOVE_FOCUS_BLAST),              \
    LEVEL_UP_MOVE(92, MOVE_SLEEP_POWDER),             \
    LEVEL_UP_MOVE(95, MOVE_FRENZY_PLANT),             \
    LEVEL_UP_END

static const struct LevelUpMove sTreeckoLevelUpLearnset[] = {
    TREECKO_FAMILY_SNOW_LEARNSET
};
...
#if P_FAMILY_TORCHIC
// Snow custom learnset, family-shared (Torchic/Combusken/Blaziken identical).
#define TORCHIC_FAMILY_SNOW_LEARNSET                  \
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),                  \
    LEVEL_UP_MOVE( 1, MOVE_LEER),                     \
    LEVEL_UP_MOVE( 5, MOVE_EMBER),                    \
    ...
    LEVEL_UP_MOVE(21, MOVE_CIRCLE_THROW),             \
    ...
    LEVEL_UP_MOVE(58, MOVE_THUNDER_PUNCH),            \
    LEVEL_UP_MOVE(64, MOVE_DRAIN_PUNCH),              \
    ...
    LEVEL_UP_MOVE(92, MOVE_BRAVE_BIRD),               \
    LEVEL_UP_MOVE(95, MOVE_BLAST_BURN),               \
    LEVEL_UP_END

static const struct LevelUpMove sTorchicLevelUpLearnset[] = {
    TORCHIC_FAMILY_SNOW_LEARNSET
};
...
#if P_FAMILY_MUDKIP
// Snow custom learnset, family-shared (Mudkip/Marshtomp/Swampert identical).
#define MUDKIP_FAMILY_SNOW_LEARNSET                   \
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),                   \
    LEVEL_UP_MOVE( 1, MOVE_GROWL),                    \
    LEVEL_UP_MOVE( 5, MOVE_WATER_GUN),                \
    ...
    LEVEL_UP_MOVE(71, MOVE_WATERFALL),                \
    LEVEL_UP_MOVE(77, MOVE_EARTHQUAKE),               \
    LEVEL_UP_MOVE(85, MOVE_BODY_SLAM),                \
    LEVEL_UP_MOVE(90, MOVE_LIQUIDATION),              \
    LEVEL_UP_MOVE(92, MOVE_OUTRAGE),                  \
    LEVEL_UP_MOVE(95, MOVE_HYDRO_CANNON),             \
    LEVEL_UP_END

static const struct LevelUpMove sMudkipLevelUpLearnset[] = {
    MUDKIP_FAMILY_SNOW_LEARNSET
};
...
// Snow custom learnset, family-shared base (17 entries identical Poochyena/Mightyena).
// Exception: Obstruct — Poochyena learns at Lv 32 (reward for delaying evolution),
// Mightyena learns at Lv 95 (the player-side Snow level cap).
static const struct LevelUpMove sPoochyenaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(32, MOVE_OBSTRUCT),
    ...
    LEVEL_UP_MOVE(68, MOVE_SUPER_FANG),
...
static const struct LevelUpMove sMightyenaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(68, MOVE_SUPER_FANG),
    LEVEL_UP_MOVE(75, MOVE_FOUL_PLAY),
    LEVEL_UP_MOVE(95, MOVE_OBSTRUCT),
    LEVEL_UP_END
};
...
// King's Shield is the per-evolution split: Aron learns it at Lv 57
// (delay-evolution reward) while Lairon and Aggron learn it at Lv 95.
static const struct LevelUpMove sAronLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(82, MOVE_STEALTH_ROCK),
    LEVEL_UP_END
};

#define ARON_LINE_EVOLVED_LEARNSET                    \
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),                   \
    LEVEL_UP_MOVE( 5, MOVE_HARDEN),                   \
    LEVEL_UP_MOVE( 8, MOVE_ROAR),                     \
    LEVEL_UP_MOVE(11, MOVE_ROCK_THROW),               \
...
// Snow custom learnset (Pachirisu is single-stage in Boralyss dex).
static const struct LevelUpMove sPachirisuLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(64, MOVE_VOLT_SWITCH),
    LEVEL_UP_MOVE(77, MOVE_SUPER_FANG),
    LEVEL_UP_MOVE(81, MOVE_THUNDER),
    LEVEL_UP_MOVE(92, MOVE_ENDEAVOR),
    LEVEL_UP_END
};
...
#if P_FAMILY_SNOVER
// Snow custom learnset, family-shared (Snover/Abomasnow identical).
#define SNOVER_FAMILY_SNOW_LEARNSET                   \
    LEVEL_UP_MOVE( 1, MOVE_POWDER_SNOW),              \
    LEVEL_UP_MOVE( 1, MOVE_LEAFAGE),                  \
...
// Snow custom learnset. 15 entries shared across the family at identical levels;
// Stealth Rock is the per-evolution split: Roggenrola learns it at Lv 46
// (delay-evolution reward) while Boldore and Gigalith learn it at Lv 92.
static const struct LevelUpMove sRoggenrolaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(69, MOVE_ROCK_BLAST),
    LEVEL_UP_MOVE(74, MOVE_EARTHQUAKE),
    LEVEL_UP_MOVE(81, MOVE_STONE_EDGE),
    LEVEL_UP_MOVE(85, MOVE_OUTRAGE),
    LEVEL_UP_END
};

#define ROGGENROLA_LINE_EVOLVED_LEARNSET              \
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),                   \
    LEVEL_UP_MOVE( 1, MOVE_HARDEN),                   \
    LEVEL_UP_MOVE( 5, MOVE_ENDURE),                   \
    LEVEL_UP_MOVE( 8, MOVE_ROCK_THROW),               \
    ...
    LEVEL_UP_MOVE(81, MOVE_STONE_EDGE),               \
    LEVEL_UP_MOVE(85, MOVE_OUTRAGE),                  \
    LEVEL_UP_MOVE(92, MOVE_STEALTH_ROCK),             \
    LEVEL_UP_END

static const struct LevelUpMove sBoldoreLevelUpLearnset[] = {
    ROGGENROLA_LINE_EVOLVED_LEARNSET
};
