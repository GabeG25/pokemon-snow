...
const u8 gText_ThisIsAPokemon[] = _("This right here is what we\ncall a 'POKéMON',{PAUSE 96}\lbut I'm sure you already knew that.\p");
...
const u8 gText_DexHoennTitle[] = _("BORALYSS DEX");
...
const u8 gText_DexHoennDescription[] = _("BORALYSS region's POKéDEX");
